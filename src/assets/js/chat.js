...
const newMessage = (data) => `<li class="clearfix">
                    <div class="message-data ${data.name !== variables.userName ? '' : 'align-right'}">
                        ${data.name !== variables.userName ? `
...
const bar = (user, time) => `<li class="clearfix">
                ...
                <div class="about">
                    ${user.socketId !== null ? `
                    <div class="name">${user.name}</div> <div class="offline-time"> Online </div>` : `
                    <div class="name">${user.name}</div> <div class="offline-time"> Last seen ${time}</div>`}
                </div>
            </li>`;
